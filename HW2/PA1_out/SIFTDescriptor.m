...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for y=0:num_histograms-1
            for x=0:num_histograms-1
                 mg = patch_mag((y*pixelsPerHistogram+1):((y+1)*pixelsPerHistogram), (x*pixelsPerHistogram+1):((x+1)*pixelsPerHistogram));
                 th = patch_theta((y*pixelsPerHistogram+1):((y+1)*pixelsPerHistogram), (x*pixelsPerHistogram+1):((x+1)*pixelsPerHistogram));
                 [histogram, ~] = ComputeGradientHistogram(num_angles, mg, th);
                 feature = [feature,histogram];
            end
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:(rows*cols)
        index = ceil(gradient_angles(i) / angle_step);
        histogram(index) =histogram(index)+ gradient_magnitudes(i); 
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    direction = (index(1) - 1) * (2 * pi / num_bins);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
%                                 END YOUR CODE                                %
%                                                                              %
